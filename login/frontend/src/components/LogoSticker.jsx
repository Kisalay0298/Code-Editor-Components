...
const LogoSticker = () => {
  return (
    <>
        <div className="flex items-center mb-8 text-white select-none">
            ...
            <p style={{ fontFamily: "Poppins, sans-serif", fontWeight: 200 }} className="text-sm text-green-500">Empower Your Wisdom to Code</p>
            </div>
        </div>
    </>
  )
