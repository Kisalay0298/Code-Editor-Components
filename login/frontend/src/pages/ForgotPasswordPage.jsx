        ...
        <div className="p-8">
            ...
            {!isSubmitted ? (
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        <span className="tracking-wide text-lg">{isLoading ? <Loader className="size-6 animate-spin mx-auto" /> : "Send Reset Link"}</span>
                    </motion.button>
                </form>
            ) : (
                <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-6">
                        if an account exists for {email}, you will receive a password reset link shorttly.
                    </p>
                </div>
            )}
        </div>
